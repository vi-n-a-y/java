...
public class ListExample {
    public static void main(String args[]) {
        ...
        ls.add(2, "green");// its add element in the index and move old element on move right side in the
                           // list.
        ...
        System.out.println("Is this list contains this element : " + ls.contains("orange"));// it checks the element
                                                                                            // present in the list or
                                                                                            // not,return true if it is
                                                                                            // present.
        System.out.println("Getting element from the list : " + ls.get(2));// it gets the element based on index from
                                                                           // the list.
        ...
        System.out.println("");
        System.out.println("using iterator interface to iterate.");
